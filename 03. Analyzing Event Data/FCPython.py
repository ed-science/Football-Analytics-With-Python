...
def createPitch(length,width, unity,linecolor):    # in meters
    ...
    if unity == "meters":
        if length >= 120.5 or width >= 75.5:
            return "Field dimensions are too big for meters as unity, didn't you mean yards as unity?\\\x1f                       Otherwise the maximum length is 120 meters and the maximum width is 75 meters. Please try again"
